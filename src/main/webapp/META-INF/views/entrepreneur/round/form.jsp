...
<acme:form>
	...
	<acme:form-moment code="entrepreneur.round.form.label.creation" path="creation" readonly/>
	...
	<jstl:if test="${command == 'show'">
		<acme:form-textbox code="entrepreneur.round.form.label.kind" path="kind" readonly />
	</jstl:if>
